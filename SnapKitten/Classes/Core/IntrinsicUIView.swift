...
//            print("contentWidth \(contentWidth)")
            ...
            for constraint : NSLayoutConstraint in subview.constraints {
                ...
                //lessThan = -1
                //greater = 1
                if(constraint.firstAttribute == NSLayoutConstraint.NSLayoutConstraint.Attribute.width){
                    if(
...
//                            && constraint.constant > contentWidth)
                ...
                if(constraint.firstAttribute == NSLayoutConstraint.NSLayoutConstraint.Attribute.height){
